...
class AirPayQrScanGetWay extends QrScanGetWay {
	...
	public function __construct() {
        ...
        $this->method_title       = __( 'Quét Mã QR AirPay', 'woocommerce' );
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'description' => array(
                ...
                'default' => 'Hãy mở App AirPay lên và nhấn Đặt Hàng để quét mã thanh toán'
            ),
            'fullname' => array(
                'title' => __( 'Tên chủ tài khoản AirPay', 'woocommerce' ),
                'type' => 'text',
                'description' => __( 'Tên chủ tài khoản AirPay', 'woocommerce' ),
                'default' => '',
                'desc_tip'      => true,
            ),
            'phone' => array(
                'title' => __( 'Số Điện Thoại AirPay', 'woocommerce' ),
                'type' => 'text',
                'description' => __( 'Số điện thoại đăng ký AirPay', 'woocommerce' ),
                'default' => '',
                'desc_tip'      => true,
            ),
            'qr_image_url' => array(
                ...
                'default' => 'Cám ơn bạn đã thanh toán. Đơn hàng của bạn sẽ được hệ thống tự động xử lý từ 5 - 10 phút.',
                'desc_tip'      => false,
            ),
