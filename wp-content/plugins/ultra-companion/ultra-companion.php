...
/** Necessary Constants **/
defined( 'ULC_VERSION' ) or define( 'ULC_VERSION', '1.0.7' ); //plugin version
                ...
                <div class="wpop_notice_content_wrap">
                    <div class="wpop_notice_content">
                    	<?php if(get_template() == 'ultra-seven'){?>
	     			    ...
	     			    <?php } elseif(get_template() == 'opstore'){?>
		     			...
		     			<?php }else{ ?>	
		     				...
		     				<a class="wpop_button" href="https://wpoperation.com/themes" target="_blank">Details</a>
		     			<?php }?>	
     				</div>
                    <div class="wpop_notice_after_content"></div>
                </div>
