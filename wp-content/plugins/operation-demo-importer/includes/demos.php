...
if ( ! class_exists( 'WPOP_Demos' ) ) {
	...
	class WPOP_Demos {
		...
		public function __construct() {
            ...
            //Demo content URL
			$this->demo_content_url = 'https://raw.githubusercontent.com/wpoperation/'.get_template().'-demo-data/master/';
		...
		public static function get_demos_data() {
			...
			// Return
			$file= 'https://raw.githubusercontent.com/wpoperation/'.get_template().'-demo-data/master/config.json';
	    ...
	    public static function popup() {
	        ...
	        if ( ( 'themes.php' == $pagenow && 'wpop-install-demos' == $_GET['page'] )
	            || ( 'themes.php' == $pagenow && 'welcome-page' == $_GET['page'] ) ) { ?>
		...
		public static function ajax_demo_data() {
			...
			$theme_option = isset( $demos[$demo]['theme_options'] ) ? $demos[$demo]['theme_options'] : '';
				...
				if ( ! is_wp_error( $api ) ) { // confirm error free
					...
					<div class="wpop-plugin wpop-clr wpop-plugin-<?php echo $api['slug']; ?>" data-slug="<?php echo $api['slug']; ?>" data-init="<?php echo $api['init']; ?>">
						...
						if ( 'premium' == $return
							...
							<a class="button" href="#" target="_blank"><?php esc_html_e( 'Get This Addon', 'wpop-demo-importer' ); ?></a>
						<?php
						} else { ?>
		...
		*/
		...
		public function ajax_after_import() {
			...
			if ( $_POST['wpop_import_is_xml'] === 'true' ) {
				...
				//status Flag
				$opt_id = 'theme_mods_'.get_template();
