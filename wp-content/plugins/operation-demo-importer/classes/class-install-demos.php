...
class WPOP_Install_Demos {
	...
	public function add_page() {
		...
		$title = '<span style="color: #00b7ea">' . esc_html__( 'WPOP Demo Import', 'wpop-demo-importer' ) . '</span>';
			...
			<div class="theme-browser rendered">
				...
				<div class="themes wp-clearfix">
					...
					foreach ( $demos as $demo => $key ) {
                         $image_path = 'https://raw.githubusercontent.com/wpoperation/'.get_template().'-demo-data/master/'.$demo.'/screenshot.png';
						// Vars
