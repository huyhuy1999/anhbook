 ...
 */
class WalkerCatalogMega extends Walker_Nav_Menu
{
    /**
    ...
    {
        if ($depth == 0) {
            $output .= '<div class="table-nav__drop" data-megamenu-item><div class="cols-nav"><div class="cols-nav__row" data-megamenu-wrap="false"><ul class="cols-nav__col" data-megamenu-coll="1">';
        } else {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        switch ($depth) {
            case 0:
                $attributes = ' class="table-nav__link"';
                break;
            case 1:
